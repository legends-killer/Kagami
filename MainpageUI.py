...
class Ui_MainPage(object):
    ...
    def setupUi(self, Dialog):
        ...
        self.weatherText.setGeometry(QtCore.QRect(405, 170, 600, 50))
        font = QtGui.QFont()
        font.setPointSize(30)
        self.weatherText.setFont(font)
        self.weatherText.setText("")
        self.weatherText.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignRight|QtCore.Qt.AlignRight)
        ...
        self.weatherIcon.setGeometry(QtCore.QRect(740, 25, 120, 120))
